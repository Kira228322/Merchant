    ...
    public class Container : Runtime.Object, INamedContent
    {
        ...
        public Dictionary<string, Runtime.Object> namedOnlyContent
        {
            get
            {
                ...
                {
                    if (c is INamedContent named && named.hasValidName)
                    {
            ...
            set
            {
                ...
                {
                    if (kvPair.Value is INamedContent named)
        ...
        {
            if (contentObj is INamedContent namedContentObj && namedContentObj.hasValidName)
            {
        ...
        public void BuildStringOfHierarchy(StringBuilder sb, int indentation, Runtime.Object pointedObj)
        {
            ...
            for (int i = 0; i < content.Count; ++i)
            {
                ...
                if (obj is not Container && obj == pointedObj)
                {
                    sb.Append("  <---");
                }
