...
namespace Ink.Runtime
{
	...
	public class Story : Runtime.Object
    {
        ...
        bool IsTruthy(Runtime.Object obj)
        {
            ...
            if (obj is Value val)
            {
                if (val is DivertTargetValue divTarget)
                {
        ...
        bool PerformLogicAndFlowControl(Runtime.Object contentObj)
        {
            ...
            // Divert
            if (contentObj is Divert currentDivert)
            {
                ...
                if (currentDivert.hasVariableTarget)
                {
                    ...
                    else if (varContents is not DivertTargetValue)
                    {
            ...
            else if (contentObj is ControlCommand evalCommand)
            {
                switch (evalCommand.commandType)
                {
                    ...
                    case ControlCommand.CommandType.ReadCount:
                        ...
                        if (target is not DivertTargetValue)
                        {
                            string extraNote = "";
            ...
            // Variable assignment
            else if (contentObj is VariableAssignment varAss)
            {
            ...
            // Variable reference
            else if (contentObj is VariableReference varRef)
            {
            ...
            else if (contentObj is NativeFunctionCall func)
            {
