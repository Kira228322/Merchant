    ...
    public static class SimpleJson
    {
        ...
        class Reader
        {
            ...
            object ReadNumber()
            {
                ...
                {
                    var c = _text[_offset];
                    if (c is '.' or 'e' or 'E') isFloat = true;
                    if (IsNumberChar(c))
                        continue;
                    else
                        break;
        ...
        public class Writer
        {
            ...
            void StartNewObject(bool container)
            {
                ...
                if (container)
                    Assert(state is State.None or State.Property or State.Array);
                else
                    Assert(state is State.Property or State.Array);
                ...
                if (state is State.Array or State.Property)
                    IncrementChildCount();
            }
