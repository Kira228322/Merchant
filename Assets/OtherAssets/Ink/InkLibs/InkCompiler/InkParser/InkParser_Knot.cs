...
namespace Ink
{
    public partial class InkParser
    {
        ...
        protected ExternalDeclaration ExternalDeclaration()
        {
            ...
            if (Expect(BracketedKnotDeclArguments, "declaration of arguments for EXTERNAL, even if empty, i.e. 'EXTERNAL " + funcIdentifier + "()'") is not List<FlowBase.Argument> parameterNames)
