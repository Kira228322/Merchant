...
namespace Ink.Parsed
{
    public abstract class Object
    {
        ...
        public Parsed.Path PathRelativeTo(Parsed.Object otherObj)
        {
            ...
            var ancestor = this;
            while (ancestor && (ancestor != commonFlowAncestor) && ancestor is not Story)
            {
                ...
                if (!hasWeavePoint)
                {
                    if (ancestor is IWeavePoint weavePointAncestor && weavePointAncestor.identifier != null)
                    {
        ...
        {
            if (this is T tObj && (queryFunc == null || queryFunc(tObj) == true))
            {
                return tObj;
            }
