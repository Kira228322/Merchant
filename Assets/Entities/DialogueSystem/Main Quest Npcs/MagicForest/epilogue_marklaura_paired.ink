...
<color=lightblue>Лаура:</color>Оно практически готово. В этом месте полно магической энергии, так что мы должны найти способ запитать и запустить его.
    +[Смотрите, там кто-то стоит.]
        ...
        <color=green>Марк:</color>Не похож на бандита. Однако этот человек кажется знакомым...
        Для начала пойдем и попробуем поговорить с ним. Нас трое и на нашей стороне сильный маг.
->END
=== generic ===
Ок
->END