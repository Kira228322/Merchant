...
public class NPCTrader : NPC
{
    ...
    public List<TraderBuyCoefficient> BuyCoefficients => _npcTraderData.BuyCoefficients; //“аких BuyCoefficients будет столько, сколько всего есть Item.ItemType (см.ниже)
