...
public class Node : MonoBehaviour
{
    ...
    public IEnumerator MoveNPCByNode(NPCMovement movement)
    {
        ...
        movement.StartPosition = movement.transform.position;
        Vector3 targetPos = new(movement.StartPosition.x + movement.MoveDistanceAndDirection, movement.StartPosition.y);
    ...
    public IEnumerator MovePlayerByNode(PlayerMover movement)
    {
        ...
        Vector3 targetPos = new(startPos.x + moveDistanceAndDirection, startPos.y);
