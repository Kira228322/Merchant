            ...
            switch (Random.Range(0, 4))
            {
                case 0:
                    description = "Таинственный странствующий цирк приглашает вас на представление! " +
                                  "Билет не стоит ни копейки! Напротив - вы сами получите случайный предмет или 125 золота после представления.";
                    break;
                case 1:
                    description = "Приглашение на театральное представление. Вам будет предоставлено зрелище к просмотру." +
                                  "Никаких взносов, оплат и прочего. После просмотра вы получите случайный предмет или 125 золота.";
                    break;
                case 2:
                    description = "Временная акция! Посмотри представление и получи случайный предмет или 125 золота! Успей воспользовать!";
                    break;
                case 3:
                    description = "Если вы это читаете, то вам неслыханно повезло! Посмотрите магическое шоу совершенно бесплатно!" +
                                  "А после просмотра получите случайный предмет или 125 золота!";
                    break;
            }
